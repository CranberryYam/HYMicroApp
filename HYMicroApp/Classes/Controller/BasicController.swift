...
public class BasicController: UIViewController {
    ...
    private lazy var quitButton:UIButton = {
        ...
        button.setBackgroundImage(self.loadImage("quit","HYMicroApp"), for: .normal)
        return button
    }()
    ...
    func loadLaunchView(imageName:String = "Music", title:String = "Music") {
        self.launchV.setDatas(imageName: imageName, title: title)
